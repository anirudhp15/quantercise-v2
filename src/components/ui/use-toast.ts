...
// Keep the original object for runtime use
const ACTION_TYPES = {
  ADD_TOAST: "ADD_TOAST",
...
// Define ActionType using the values of the object
...
// Define a more specific Action type based on the reducer logic
type Action =
...
const reducer = (state: State, action: Action): State => {
  switch (action.type) {
    ...
    // Add default case to satisfy TypeScript
    default:
      return state;
  }
};
